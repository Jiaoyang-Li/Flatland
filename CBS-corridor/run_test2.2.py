...
framework = "LNS"  # "LNS" for large neighborhood search or "GPP" for group prioritized planning or "Parallel-LNS" for parallel lns  "Parallel-Neighbour-LNS" for parallel lns
f_w = 1
debug = True
